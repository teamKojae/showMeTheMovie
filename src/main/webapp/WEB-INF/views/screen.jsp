						...
						<div class="seat-section">
							<div class="tit-util">
								...
								<h3 class="tit small">
									...
									관람 인원 선택 <select class="selectBox" id="selectBox"
										name="numberOf" size="1" onchange="OnChange();">
							...
							<form action="/kakaoPay" method="post" id="kakaoPay">
								<div class="seat-result">
									<div class="wrap">
										...
										<div class="info-area" id="test" data-area="selectedSeat"
											value=""></div>
										...
										<div class="pay-area">
											...
											<div class="pay">
												...
												<div class="money" id="money">
													<input type="hidden" name="totalPeople" value="1"
														id="totalPeople"> <input type="hidden"
														name="totalPrice" value="0" id="totalPrice">
