...
public class KakaoPay {
	 private static final String HOST = "https://kapi.kakao.com";
	    ...
	    public String kakaoPayReady(Movie movie, User user,MovieInfo movieInfo) {
	        ...
	        params.add("approval_url", "http://110.35.185.66:5000/kakaoPaySuccess");		
	        params.add("cancel_url", "http://110.35.185.66:5000/kakaoPayCancel");
	        params.add("fail_url", "http://110.35.185.66:5000/kakaoPaySuccessFail");
